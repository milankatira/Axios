...
//TODO Promise then | Single Data | Showing Data in Browser
function makerequest() {
  console.log("Button Clicked")
  axios('https://jsonplaceholder.typicode.com/posts/1')
    .then((res) => {
...
//TODO Promise Then | Multiple Data
function makerequest() {
  console.log("Button Clicked")
...
//TODO Promise Then | Multiple Data | Showing Data in Browser
function makerequest() {
  console.log("Button Clicked")
  axios('https://jsonplaceholder.typicode.com/posts/')
    .then((res) => {
...
//TODO Async and Await | Single Data
...
//TODO Async and Await | Single Data | Showing Data in Browser
async function makerequest() {
  try {
    console.log("Button Clicked")
    const res = await axios('https://jsonplaceholder.typicode.com/posts/1')
...
//TODO Async and Await | Multiple Data
async function makerequest() {
  try {
    console.log("Button Clicked")
...
//TODO Async and Await | Multiple Data | Showing Data in Browser
async function makerequest() {
  try {
    console.log("Button Clicked")
